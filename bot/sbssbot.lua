...
function create_config( )
  ...
  config = {
    ...
    sudo_users = {245333470},--Sudo users
    disabled_channels = {},
...
Admins : @ma_wtin  [Developer]
برای خرید گپ به آیدی اول و برای خرید آموزش ساخت ربات ضد اسپم و ساخت ربات ضد اسپم به @ma_wtin مراجعه 
]],
    help_text = [[
لیست دستورات 
!kick [username|id]
